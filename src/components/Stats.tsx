...
const StatItem = ({
  ...
  return <div ref={ref} className="flex-1 p-6 md:p-8 relative transition-all duration-300 text-center" onMouseEnter={() => setIsHovering(true)} onMouseLeave={() => setIsHovering(false)}>
...
export default function Stats() {
  ...
  return <section id="stats" ref={sectionRef} className="py-24 px-6 md:px-12 relative cursor-text" data-cursor="text">
      {/* Mouse light glow effect */}
      <div className="absolute pointer-events-none rounded-full bg-gradient-to-r from-primary/10 to-accent-foreground/10 mix-blend-overlay blur-3xl" style={{
      width: '30vw',
      height: '30vw',
