...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 px-6 md:px-12 bg-secondary/30 relative overflow-hidden cursor-text">
      ...
      <div 
        className="absolute right-0 top-0 opacity-5 pointer-events-none overflow-hidden z-0"
        style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-all duration-700 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-20"}`}>
            ...
            <div className="space-y-6 relative">
              <p 
                className="text-muted-foreground text-lg font-light overflow-hidden relative"
                style={{
              ...
              {/* Animated line */}
              <div 
                className="w-full h-px bg-primary/20 my-8"
                style={{
            ...
            >
              ...
              >
                ...
                <circle 
                  ...
                  cy="200" 
                  r="50" 
                  className="fill-primary/20 animate-float-slow" 
                  style={{ 
                    animationDelay: "0.2s",
                ...
                <rect 
                  ...
                  width="100" 
                  height="100" 
                  className="fill-primary/15 animate-float-slow" 
                  style={{ 
                    animationDelay: "0.5s",
                ...
                <polygon 
                  ...
                  className="fill-primary/25 animate-float-slow" 
                  style={{ 
                    animationDelay: "0.8s",
                    transform: `translate(${normalizedX * -20}px, ${normalizedY * -20}px)`,
                    transition: "transform 0.3s ease-out",
                ...
                <path 
                  ...
                  className="stroke-primary/40 fill-none animate-float-slow" 
                  style={{ 
                    strokeWidth: "4", 
                    animationDelay: "1.1s",
